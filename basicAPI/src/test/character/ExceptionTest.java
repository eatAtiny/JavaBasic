...
/**
 * * ExceptionTest是Java中异常处理的测试类。
 * * Exception是Java中异常处理的基类，提供了异常的基本功能。
 * * RuntimeException是Exception的一个子类，表示运行时异常。编译时一般不会出现这种异常。
 *  处理异常一般有两种方式：
 *      一种是使用try-catch语句块来捕获异常并处理它；
...
public class ExceptionTest {
    ...
    /**
     * ExceptionDemo方法演示了如何处理编译时异常ParseException。
     * 该方法将字符串解析为日期对象，可能会抛出ParseException。
     *
