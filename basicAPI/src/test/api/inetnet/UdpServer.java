...
public class UdpServer {
    ...
    public void udpServerDemo() {
        ...
        try (java.net.DatagramSocket socket = new java.net.DatagramSocket(9876)) { // 创建一个DatagramSocket对象，绑定到指定端口

            byte[] buffer = new byte[1024]; // 创建接收缓冲区
            java.net.DatagramPacket packet = new java.net.DatagramPacket(buffer, buffer.length); // 创建DatagramPacket对象
