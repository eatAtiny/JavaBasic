...
/**
 * 线程同步：
 *  1. 使用synchronized关键字来修饰方法或代码块，确保同一时刻只有一个线程可以执行被修饰的方法或代码块。
 *  2. 使用Lock接口和ReentrantLock类来实现更灵活的锁机制，可以实现公平锁和非公平锁。
 */
public class ThreadSynTest1 {
    ...
    public static synchronized void ThreadSynDemo2() { // 这里隐式使用了synchronized修饰静态方法 synchronized(ClassName.class)
