package com.github.eatAtiny.character.reflect;
...
public class ReflectTest {
  ...
  /** 反射机制的使用示例： 1. 获取类的Class对象 2. 创建类的实例 3. 获取类的方法、字段等信息 4. 调用方法或访问字段 */
  @Test
  ...
  public void reflectDemo2() throws Exception {
    ...
    Constructor reflectConstructor =
        reflectClass.getDeclaredConstructor(int.class, String.class); // 获取指定参数类型的构造方法
    ...
    ReflectClass reflectInstance =
        (ReflectClass) reflectConstructor.newInstance(1, "Test Name"); // 创建类的实例
    ...
    Method reflectMethod =
        reflectClass.getDeclaredMethod("setName", String.class); // 获取指定名称和参数类型的公共方法
  ...
  public void reflectDemo3() throws Exception {
    /** 反射的作用： 1.获取类的所有成分 2.破坏封装，访问私有成员 3.绕过泛型约束 */
